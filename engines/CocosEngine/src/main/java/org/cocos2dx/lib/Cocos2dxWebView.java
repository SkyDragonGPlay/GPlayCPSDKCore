...
final class ShouldStartLoadingWorker implements Runnable {
...
public final class Cocos2dxWebView extends WebView {
    ...
    class Cocos2dxWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, final String urlString) {
            ...
            Cocos2dxActivity.COCOS_ACTIVITY.runOnGLThread(new ShouldStartLoadingWorker(latch, result, mViewTag, urlString));
