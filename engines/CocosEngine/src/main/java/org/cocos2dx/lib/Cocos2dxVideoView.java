...
public final class Cocos2dxVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    private void openVideo() {
        ...
        Cocos2dxActivity.GAME_ACTIVITY.sendBroadcast(i);
        ...
        try {
            ...
            if (mIsAssetRouse) {
                AssetFileDescriptor afd = Cocos2dxActivity.GAME_ACTIVITY.getAssets().openFd(mVideoFilePath);
                mMediaPlayer.setDataSource(afd.getFileDescriptor(),afd.getStartOffset(),afd.getLength());
            } else {
                mMediaPlayer.setDataSource(Cocos2dxActivity.GAME_ACTIVITY, mVideoUri);
            }
    ...
    private OnErrorListener mErrorListener =
        ...
        public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
            ...
            if (getWindowToken() != null) {
                ...
                new AlertDialog.Builder(Cocos2dxActivity.GAME_ACTIVITY)
